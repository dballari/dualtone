...
<p class="has-text-align-center has-medium-font-size">Join my list and get access to my content creation guide</p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"textAlign":"center"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-text-align-center wp-element-button">yes, please!</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover -->
...
<p class="has-base-color has-text-color has-link-color has-small-font-size">© 2024 <a href="https://ballarinconsulting.com/dualtone">Dualtone</a> · Proudly powered by <a href="https://wordpress.org">WordPress</a> · by David&nbsp;Ballarin&nbsp;Prunera · <a href="http://dualtone.local/privacy-policy/" data-type="page" data-id="3">Privacy</a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base","fontSize":"small"} -->
<p class="has-base-color has-text-color has-link-color has-small-font-size"><a href="#top">top ↑</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->

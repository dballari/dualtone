...
<p class="has-base-color has-text-color has-link-color has-small-font-size">&copy; <?php echo date("Y"); ?> <a href="https://ballarinconsulting.com/dualtone">DualTone</a> · <?php echo $prowdly ?> · <?php esc_html_e( 'by', 'dualtone' ); ?> David&nbsp;Ballarin&nbsp;Prunera · <a href="#"><?php esc_html_e( 'Privacy', 'dualtone' ); ?></a></p>
<!-- /wp:paragraph -->

...
* downgrade php version to make it compatible with WordPress theme preview

= 1.0.0 =
* update description
* add sidebar patterns with different menus
* updated readme file
...
= 0.9.4 = 
* increase version in style.css
* remove some text from Demo section of README.md
* remove getting started from README.md
* made some string translatable
* summarize description
* remove accessibility tag
...
= 0.8.8 =
* add responsive writing mode helper class style 

= 0.8.7 =
* some style and weights fix
